                ...
                <table class="table table-striped table-condensed">
                    ...
                    @foreach($listnews as $stt => $news)
                        <tr>
                            ...
                            <td  style="font-size: 70% !important" class="text-primary"><a target="_blank" href="{{route('chitiet',$news->slug)}}">{{$news->tieude}}</a></td>
                            <td class="none-manage-tour">{{$news->tomtat}}</td>

                            <td class="none-manage-tour">{{$news->id_diemden}}</td>
                            <td><img style="width: 100px" src="../../img/news/{{$news->avatar}}"></td>
                            <td >
                                <a  href="{{route('getchangenews',$params = ['id'=> $news->id])}}">
