                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-3">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="{{route('chitiettour',$params = ['id'=> $tour->id])}}">
                                                    <img class="pic-1"
                                            ...
                                            <div class="product-content">
                                                <h3 class="title"><a href="{{route('chitiettour',$params = ['id'=> $tour->id])}}">{{$tour->name}}<img
                                                            src="{{asset('img/hot.gif')}}" alt=""></a></h3>
                                                <div class="price">{{$tour->gia}}
                                                    <span>{{$tour->giamoi}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-3">
                                                <div class="product-grid">
                                                    ...
                                                    <div class="product-content">
                                                        <h3 class="title"><a href="{{route('chitiettour',$params = ['id'=> $tour->id])}}<img
                                                                    src="{{asset('img/hot.gif')}}" alt=""></a></h3>
                                                        <div class="price">{{$tour->gia}}
                                                            <span>{{$tour->giamoi}}</span>
                                                        </div>
            ...
            <div class="col-md-4 col-xs-12 col-sm-12 p-2">
                <div class="card rounded">
                    ...
                    <div class="card-image-overlay m-auto">
                        <span class="card-detail-badge">{{$tour->giamoi}}</span>
                        <span class="card-detail-badge khuyenmai-giamgia"><Strike>{{$tour->gia}}</Strike></span>
                    </div>
                    <div class="card-body text-center">
                        <div class="ad-title m-auto">
                            <h5>{{$tour->name}}</h5>
                        </div>
                        <a class="ad-btn" href="{{route('chitiettour',$params = ['id'=> $tour->id])}}">Xem</a>
                    </div>
                </div>
            </div>
                ...
                <li class="col-12 col-md-6 col-lg-3">
                    <div class="cnt-block equal-hight">
                        ...
                        <ul class="follow-us clearfix">
                            <li><a href="{{route('diemden')}}"><h3>{{$des->name}}</h3></a></li>
