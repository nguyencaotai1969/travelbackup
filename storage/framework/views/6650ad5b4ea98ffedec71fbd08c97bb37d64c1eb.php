                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                                ...
                                                <a class="p-1 badge badge-primary rounded-0"
                                                   href="<?php echo e(route('chitiet',$news->id)); ?>"><marquee direction="right"><?php echo e($news->tieude); ?></marquee></a>
        ...
        <?php $__currentLoopData = $listnews2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stt => $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row tintuc-mgbt">
                <div class="col-md-4 image-wrapper">
                    <a href="<?php echo e(route('chitiet',$news->id)); ?>" class="zoom">
                        <img width="340" class="img-fluid" height="200" src="../public/img/news/<?php echo e($news->avatar); ?>"></a>
                </div>
                <div class="col-md-8  ">
                    <a href="<?php echo e(route('chitiet',$news->id)); ?>">
                    ...
                    <p style="border-radius: 9px">
                        <a href="<?php echo e(route('chitiet',$news->id)); ?>"><b> Chi Tiết ...</b></a>
                    </p>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
