        ...
        <div class="container detail-des">
            ...
            <div class="row text-left text-xs-center text-md-left" id="des-detail">
                <div class="image-1 col-md-5">
                    <img class="col-md-12" src="../../public/img/des/<?php echo e($des->img); ?>" alt="">
                </div>
                <div class="detail col-md-7 ml-auto">
                    <p><?php echo $des->gioithieu; ?></p>
            ...
            <div class="row" id="list">
                <div class="col-lg-9 col-md-12" id="tour-list">
                    ...
                    <div class="tour row">
                        ...
                        <div class="info col-md-8">
                            <h5><a href="<?php echo e(route('chitiettour',$params = ['id'=> $tour->slug])); ?>"><b><?php echo e($tour->name); ?></b></a></h5>
                            <div class="row">
                ...
                <div class="col-lg-3 col-md-12" id="list-news">
                    ...
                    <div class="row news pt-2">
                        ...
                        <p><img src="../img/news/<?php echo e($news->avatar); ?>" alt=""></p>
                        <b class="text-primary"><?php echo e($news->tieude); ?></b>
                            <hr>
                        </a>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
