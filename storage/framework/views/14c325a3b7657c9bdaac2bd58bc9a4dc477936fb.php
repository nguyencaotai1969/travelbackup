<section class="title-bar">
    ...
    <div class="logo col-md-6">
        <h1><a href="<?php echo e(route('trangchu')); ?>" target="_blank"><img src="<?php echo e(asset('img/logo.png')); ?>" alt=""/></a></h1>
    </div>
                ...
                <ul class="nofitications-dropdown">
                    <li class="dropdown head-dpdn">
                        ...
                        <ul class="dropdown-menu anti-dropdown-menu w3l-msg">
                            ...
                            <li>
                                ...
                                <a href="#">
                                    <div class="user_img"><img src="<?php echo e(asset('img/admin/1.png')); ?>" alt=""></div>
                            ...
                            <li class="odd"><a href="#">
                                    <div class="user_img"><img src="<?php echo e(asset('img/admin/2.png')); ?>" alt=""></div>
                                    <div class="notification_desc">
                                        <p>Lorem ipsum dolor amet </p>
                                        <p><span>1 hour ago</span></p>
                                    </div>
                            ...
                            <li><a href="#">
                                    <div class="user_img"><img src="<?php echo e(asset('img/admin/3.png')); ?>" alt=""></div>
                                    <div class="notification_desc">
                                        <p>Lorem ipsum dolor amet </p>
                                        <p><span>1 hour ago</span></p>
                                    </div>
                    ...
                    <li class="dropdown head-dpdn">
                        ...
                        <ul class="dropdown-menu anti-dropdown-menu agile-notification">
                            ...
                            <li><a href="#">
                                    <div class="user_img">
                                        <img src="<?php echo e(asset('img/admin/3.png')); ?>" alt="">
                                    </div>
                                    <div class="notification_desc">
                                        <p>Lorem ipsum dolor amet </p>
                                        <p><span>1 hour ago</span></p>
