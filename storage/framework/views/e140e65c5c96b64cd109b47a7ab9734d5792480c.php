            ...
            <div class="row" id="list">
                    ...
                    <?php $__currentLoopData = $listtour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stt => $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="tour row">
                            ...
                            <div class="info col-md-8">
                                <h5><a href="<?php echo e(route('chitiettour',$params = ['id'=> $tour->slug])); ?>"><b><marquee direction="right"><marquee width="150"><?php echo e($tour->name); ?></marquee></marquee></b></a></h5>
                                <div class="row">
                                    ...
                                    <div class="right col-md-5 ml-auto">
                                        ...
                                        <span style="color: red; font-size: 22px"><b><marquee behavior="alternate"><?php echo e(number_format($tour->giamoi)); ?>đ</marquee></b></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-12" id="list-news">
                    ...
                    <div class="row news pt-4">
                        ...
                        <img src="../img/news/<?php echo e($news->avatar); ?>" style="border: 1px solid #0037ff;" alt="travel-du lich">
                                <p>
                                    <marquee behavior="alternate"><marquee width="200">
                                    <b><?php echo e($news->tieude); ?></b>
                                        </marquee></marquee>
                                </p>
                        </a>
                    </div>
