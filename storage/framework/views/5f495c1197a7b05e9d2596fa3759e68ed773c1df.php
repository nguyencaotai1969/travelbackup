        ...
        <div class="container infor-tour"><br>
            ...
            <div class="row text-left text-xs-center text-md-left" id="des-detail">
                <div class="image-1 col-md-5">
                    <img class="col-md-12" src="../storage/tour/avatar/<?php echo e($tour->avatar); ?>" alt="">
                </div>
                <div class="detail col-md-7 row">
                    <h5><b><a style="text-decoration: none" href="<?php echo e(route('chitiettour',$tour->id)); ?>"><?php echo e($tour->name); ?></a></b></h5>
                    <div class=" col-md-6">
                ...
                <form method="post" action="<?php echo e(route('luudon',$params = ['id'=> $tour->id])); ?>">
                    <div class="row">
                        ...
                        <div class="contact-right col-md-6 col-xs-6">
                            <p>Điện thoại</p>
                            <input type="phone" class="form-control" name="phone" value="" placeholder="Phone"><br>
                            <p>Địa chỉ</p>
