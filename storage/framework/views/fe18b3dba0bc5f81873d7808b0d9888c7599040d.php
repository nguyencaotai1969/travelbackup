    ...
    <ul>
        ...
        <li class="has-subnav">
            ...
            <ul>
                ...
                <li>
                    <a class="subnav-text" href="<?php echo e(route('admin_news_add')); ?>">Manage highlight</a>
                </li>
                <li>
        ...
        <li class="has-subnav">
            ...
            <ul>
                <li>
                    <a class="subnav-text" href="<?php echo e(route('Add_destination')); ?>">Add Destination</a>
                </li>
                <li>
                    <a class="subnav-text" href="<?php echo e(route('listdestination')); ?>">Manage Destination</a>
                </li>
            </ul>
        </li>
