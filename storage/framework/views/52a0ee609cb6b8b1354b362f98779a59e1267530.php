                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-3">
                                            <div class="product-grid">
                                                ...
                                                <div class="product-content">
                                                    <h3 class="title">
                                                        <a href="<?php echo e(route('chitiettour',$tour->id)); ?>"><?php echo $tour->name; ?>
                                            ...
                                            <?php $__currentLoopData = $listtour_after; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stt => $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                    <div class="product-grid">
                                                        ...
                                                        <div class="product-content">
                                                            <h3 class="title">
                                                                <a href="<?php echo e(route('chitiettour',$tour->id)); ?>"><?php echo e($tour->name); ?>
                                  ...
                                  <div class="col-md-4 col-xs-12 col-sm-12 p-2">
                                      <div class="card rounded">
                                          ...
                                          <div class="card-body text-center">
                                              ...
                                              <a class="ad-btn" href="<?php echo e(route('chitiettour',$tour->id)); ?>">
                                                  Xem
                                              </a>
                ...
                <div class="MultiCarousel" data-items="1,2,3,4" data-slide="1" id="MultiCarousel"  data-interval="1000">
                    <div class="MultiCarousel-inner">
                        ...
                        <li class="item col-12 col-md-6 col-lg-4">
                                <a href="<?php echo e(route('diemden',$des->id)); ?>">
                                    <div class="cnt-block equal-hight">
                                        <figure>
                                            <img
                                                src="storage/tour/des/<?php echo e($des->img); ?>" width="200" alt="">
                                        </figure>
