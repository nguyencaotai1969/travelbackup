...
<div class="login-wrap">
    ...
    <div class="login-html">
        <a href="<?php echo e(route('trangchu')); ?>" data-toggle="tooltip" title="Về Trang Chủ"><i class="fas fa-home"></i></a>&nbsp;&nbsp;
                ...
                <div class="sign-in-htm">
                    <div class="group">
                        ...
                        <input id="user" type="email"
                               class="input form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email"
                               value="<?php echo e(old('email')); ?>" placeholder="Email Của Bạn" required autofocus>
                    ...
                    <div class="group">
                        ...
                        <input id="password" data-type="password" type="password"
                               class="input form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>"
                ...
                <div class="for-pwd-htm">
                    <div class="group">
                        ...
                        <input id="name" type="text"
                               class="input form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name"
                               value="<?php echo e(old('name')); ?>" required autofocus placeholder="Họ Và Tên">
                    ...
                    <div class="group">
                        ...
                        <input id="email" type="email"
                               class="input form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email"
                               value="<?php echo e(old('email')); ?>" required placeholder="Địa Chỉ Email Của Bạn">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="card card-outline-secondary">
                    ...
                    <?php endif; ?>
                        <form class="form" action="<?php echo e(route('password.email')); ?>" method="POST" role="form" autocomplete="off">
                             <?php echo csrf_field(); ?>
