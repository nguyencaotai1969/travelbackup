            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-grid4">
                    ...
                    <div class="product-content">
                        <h3 class="title p-1"><a href="<?php echo e(route('chitiettour',$tour->slug)); ?>"><b><?php echo e($tour->name); ?></b> <img
                    ...
                    <a class="add-to-cart dat-tour-mien-bac" href="<?php echo e(route('dattour',$params = ['id'=> $tour->slug])); ?>"><b>Đặt Tour</b></a>
                </div>
            </div>
