<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row danhsachtour-tour" style="padding: 29px;margin-top: 67px">
              <h2 class="text-center text-primary"><b>Danh Sách Bài Viết</b></h2>
                ...
                <table class="table table-striped table-condensed">
                    ...
                    <?php $__currentLoopData = $listnews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stt => $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td  style="font-size: 70% !important" class="text-primary"><a target="_blank" href="<?php echo e(route('chitiet',$news->slug)); ?>"><?php echo e($news->tieude); ?></a></td>
                            <td class="none-manage-tour"><?php echo e($news->tomtat); ?></td>

                            <td class="none-manage-tour"><?php echo e($news->id_diemden); ?></td>
                            <td><img style="width: 100px" src="../../img/news/<?php echo e($news->avatar); ?>"></td>
                            <td >
                                <a  href="<?php echo e(route('getchangenews',$params = ['id'=> $news->id])); ?>">
