                ...
                <div class="titlebar">
                    ...
                    <span>
                        <a data-slide="prev" href="#Carousel" class="left carousel-control"><img
                                src="http://pluspng.com/img-png/next-button-png-open-2000.png" width="20"
                                alt="">
                        </a>
                    </span>
                        <span>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-3">
                                            <div class="product-grid">
                                                ...
                                                <div class="product-content">
                                                    <h3 class="title"><a href="<?php echo e(route('chitiettour',$tour->id)); ?>"><?php echo e($tour->name); ?><img
                                                                src="<?php echo e(asset('img/hot.gif')); ?>" alt=""></a></h3>
                                                    <div class="price"><?php echo e($tour->giamoi); ?>

                                                        <span><?php echo e($tour->gia); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <?php $__currentLoopData = $listtour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stt => $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                    <div class="product-grid">
                                                        ...
                                                        <div class="product-content">
                                                            <h3 class="title"><a href="<?php echo e(route('chitiettour',$tour->id)); ?><img
                                                                    src="<?php echo e(asset('img/hot.gif')); ?>" alt=""><?php echo e($tour->name); ?></a></h3>
                                                            <div class="price"><?php echo e($tour->giamoi); ?>
                    ...
                    <div class="card rounded">
                        <div class="card-image">
                            ...
                            <a href="<?php echo e(route('chitiettour',$tour->id)); ?>">
                                ...
                                <img class="img-fluid" src="storage/tour/avatar/<?php echo e($tour->avatar); ?>"
                                 alt="Alternate Text"/>
                            </a>
                        </div>
                        ...
                        <div class="card-body text-center">
                            <div class="ad-title m-auto">
                                <a href="<?php echo e(route('chitiettour',$tour->id)); ?>">
                                <h5><?php echo e($tour->name); ?></h5></a>
                            </div>
                            <a class="ad-btn" href="<?php echo e(route('chitiettour',$tour->id)); ?>">Xem</a>
                        </div>
                    </div>
                </div>
                ...
                <?php $__currentLoopData = $listdes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stt => $des): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="col-12 col-md-6 col-lg-3">
                        <div class="cnt-block equal-hight">
                            <figure>
                                <img
                                    src="storage/tour/des/<?php echo e($des->img); ?>" alt="">
                            </figure>

                            <ul class="follow-us clearfix">
                                <li><a href="<?php echo e(route('diemden',$des->id)); ?>"><h3><?php echo e($des->name); ?></h3></a></li>
