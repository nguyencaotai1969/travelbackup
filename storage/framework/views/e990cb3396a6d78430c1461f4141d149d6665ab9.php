                ...
                <div class="product-grid3">
                    ...
                    <div class="product-content">
                        <h3 class="title p-1"><a href="<?php echo e(route('chitiettour',$tour->id)); ?>"><b><?php echo e($tour->name); ?></b> <img
                                    ...
                                    alt=""></a></h3>
                        <div class="price">
                            <p><?php echo e($tour->giamoi); ?></p>
                            <span><?php echo e($tour->gia); ?></span>
                        </div>
                    </div>
                    <a class="add-to-cart dat-tour-mien-bac" href="<?php echo e(route('chitiettour',$tour->id)); ?>"><b>Đặt Tour</b></a>
                </div>
            </div>
            ...
            <?php $__currentLoopData = $mientrung; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stt => $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3 col-sm-6">
                    <div class="product-grid4">
                        ...
                        <a class="add-to-cart dat-tour-mien-trung" href="<?php echo e(route('chitiettour',$tour->id)); ?>"><b>Đặt Tour</b></a>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
